...
;; A set of configurations for Emacs beginners to build on.
;; Encourages use of built-in features, such as `list-packages' and
;; `customize'.  See the "README.md" file for more information.
